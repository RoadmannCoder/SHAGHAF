...
$(function () {
    ...
    ***************************/
    ...
    document.addEventListener("swup:contentReplaced", function () {
        ...
        // Apply translations after page content is replaced
        initializeLanguage();
    ...
    function setLanguage(lang) {
        ...
        // First process non-nested elements to prevent double-processing
        document.querySelectorAll('[data-translate]:not([data-translate] [data-translate])').forEach(element => {
            const key = element.dataset.translate;
            if (translations[lang] && translations[lang][key]) {
                const translation = translations[lang][key];
                
                // For elements that may contain HTML
                if (element.children.length > 0 || 
                    (translation.includes('<') && translation.includes('>'))) {
        ...
        // Then process nested elements separately to ensure they get their translations
        document.querySelectorAll('[data-translate] [data-translate]').forEach(element => {
            const key = element.dataset.translate;
            if (translations[lang] && translations[lang][key]) {
                const translation = translations[lang][key];
    ...
    $('.mil-language-switch').on('click', function(e) {
        e.preventDefault();
    ...
    // Also initialize when document is fully loaded
    $(document).ready(function() {
        initializeLanguage();
    });
    
    // Watch for dynamically added elements with translations
            ...
            if (mutation.type === 'childList' && mutation.addedNodes.length) {
                mutation.addedNodes.forEach(node => {
                    if (node.nodeType === 1) { // Element node
                        // Check if the added node has data-translate attribute
                        ...
                        // Check children of added node for data-translate
                        const transElements = node.querySelectorAll ? node.querySelectorAll('[data-translate]') : [];
